...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/5.18.0/darwin-thread-multi-2level'),
    ...
    osvers => '11.4.2',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/5.18.0'),
    scriptdir => '.../',
    sitearchexp => relocate_inc('.../../lib/site_perl/5.18.0/darwin-thread-multi-2level'),
    sitelibexp => relocate_inc('.../../lib/site_perl/5.18.0'),
    so => 'dylib',
    useithreads => 'define',
