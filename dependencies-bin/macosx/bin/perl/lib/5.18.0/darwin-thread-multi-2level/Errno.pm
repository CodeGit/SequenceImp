...
"darwin-thread-multi-2level-11.4.2" or
	die "Errno architecture (darwin-thread-multi-2level-11.4.2) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
