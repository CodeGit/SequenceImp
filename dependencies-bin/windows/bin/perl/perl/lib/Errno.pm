...
"MSWin32-x86-multi-thread-64int-4.0" or
	die "Errno architecture (MSWin32-x86-multi-thread-64int-4.0) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
