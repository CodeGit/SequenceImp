...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/5.18.2/x86_64-linux-thread-multi'),
    ...
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/5.18.2'),
    scriptdir => '/home/maq/perl/bin',
    sitearchexp => relocate_inc('.../../lib/site_perl/5.18.2/x86_64-linux'),
    sitelibexp => relocate_inc('.../../lib/site_perl/5.18.2'),
    so => 'so',
    useithreads => 'define',
